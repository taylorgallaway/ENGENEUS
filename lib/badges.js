...
export const BADGES = {
  ...
  bought_coffee: { id: 'bought_coffee', name: 'Bought a Coffee', description: 'Supported ENGENEUS with a donation.', image: '/badges/bought_coffee.png' },
  top_donator: { id: 'top_donator', name: 'Top Donator', description: 'Reached the top 5 on the donor leaderboard.', image: '/badges/top_donator.png' },
};
